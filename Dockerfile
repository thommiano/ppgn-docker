...
RUN cd /root/ && git clone https://github.com/thommiano/caffe_lrcn_joel.git
...
RUN cd /root/ppgn && sed -i "s|/path/to/your/caffe/python|/root/caffe/python |g" settings.py
